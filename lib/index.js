...
var p = e.object(Object.fromEntries(l.map((e) => [e.key, f(e)]))), m = [
	"turn/start",
	"turn/end",
	"step/start",
	"step/end",
...
var g = {
	...
	apply(e, n) {
		...
		e.on("session/event", (e, t) => {
			!t || typeof t.type != "string" || (t.type === "turn/end" && i({ type: "answer-done" }), m.includes(t.type) && i(t.data === void 0 ? { type: t.type } : {
				type: t.type,
				data: t.data
			}));
		}), e.effect(() => {
...
//#endregion
export { p as Config, s as FLAME_STYLES, o as MOLE_FREQUENCIES, a as SHAKE_LEVELS, c as SOUND_STYLES, d as THRUM_SETTINGS_NAMESPACE, g as default, u as name };
